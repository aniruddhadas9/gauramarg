...
export class CourseRegistrationService {
    ...
    public deleteUsingDELETE2(id: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.delete<Message>(`${this.configuration.basePath}/courseRegistration/${encodeURIComponent(String(id))}`,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public postUsingPOST2(attendance: CourseRegistration, observe?: 'body', reportProgress?: boolean): Observable<Message>;
    public postUsingPOST2(attendance: CourseRegistration, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Message>>;
    public postUsingPOST2(attendance: CourseRegistration, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Message>>;
    public postUsingPOST2(attendance: CourseRegistration, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (attendance === null || attendance === undefined) {
            throw new Error('Required parameter attendance was null or undefined when calling postUsingPOST2.');
        }
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public putUsingPUT2(attendance: CourseRegistration, observe?: 'body', reportProgress?: boolean): Observable<Message>;
    public putUsingPUT2(attendance: CourseRegistration, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Message>>;
    public putUsingPUT2(attendance: CourseRegistration, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Message>>;
    public putUsingPUT2(attendance: CourseRegistration, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (attendance === null || attendance === undefined) {
            throw new Error('Required parameter attendance was null or undefined when calling putUsingPUT2.');
        }
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public updateUsingGET2(attendance: CourseRegistration, observe?: 'body', reportProgress?: boolean): Observable<Message>;
    public updateUsingGET2(attendance: CourseRegistration, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Message>>;
    public updateUsingGET2(attendance: CourseRegistration, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Message>>;
    public updateUsingGET2(attendance: CourseRegistration, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (attendance === null || attendance === undefined) {
            throw new Error('Required parameter attendance was null or undefined when calling updateUsingGET2.');
        }
